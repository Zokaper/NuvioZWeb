...
| Phase                           | State                                      | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ------------------------------- | ------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0 — debug line                  | **complete**                               | `debug-release.yml` published `debug-v0.3.40-z1.5`; the next Phase B package is `.6`. The prerelease carries an unsigned WGT + IPK and remains invisible to `/releases/latest`.                                                                                                                                                                                                                                                                                 |
