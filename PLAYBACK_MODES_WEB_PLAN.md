...
| Phase                           | State                                      | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ------------------------------- | ------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0 — debug line                  | **complete**                               | `debug-release.yml` published the Phase B build as `debug-v0.3.40-z1.6` (run `32757702323`). The prerelease carries an unsigned WGT + IPK and remains invisible to `/releases/latest`.                                                                                                                                                                                                                                                                          |
...
| B — mode plumbing + Streamlined | **implemented; device acceptance pending** | The first-launch selector is integrated with existing onboarding. A quality choice seeds `playbackChain`'s three candidates; the player startup surface names failures, offers the manual escape, and advances via the progress-aware watchdog. Selection timeout and spent-chain grace are wired. 192 pure tests, ESLint, format and production build are green; app shell smoke-tested in browser. ⚠ The new route and failure path remain unwatched on a TV. |
